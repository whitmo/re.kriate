...
**YOU ARE IN: `rekriate/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/rekriate/` (rig root) or other directories
...
**Your mail address:** `rekriate/polecats/obsidian`
**Your rig:** rekriate
**Your Witness:** `rekriate/witness`
...
| Ask Witness for help | `gt mail send rekriate/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`rekriate/witness`) when:
...
```bash
gt mail send rekriate/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
