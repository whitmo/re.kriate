...
- [x] Probability & modifiers on virtual grid: add per-step trigger probability UI, alt-track modifier holds (keyboard + virtual grid), and tests using simulated grid.
